...
<input type=submit value="Go" class=sbmt>
    	...
    	<div class="cabinet-box right">
            <div class="info-block">
                ...
                <p>Use the opportunities of the "Cashouts History" section in order to improve the investment interaction with our company, as well as for receiving all the necessary information about your account</p>
                </div>
            </div>   
    	</div>
